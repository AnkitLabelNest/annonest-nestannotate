...
export const entitiesGp = pgTable("entities_gp", {
  ...
  gpShortName: text("gp_short_name"),
  ...
  numberOfFunds: integer("number_of_funds"),
  activeFundsCount: integer("active_funds_count"),
  totalCapitalRaised: numeric("total_capital_raised"),
  firstFundVintage: integer("first_fund_vintage"),
  latestFundVintage: integer("latest_fund_vintage"),
  estimatedDealCount: integer("estimated_deal_count"),
  ownershipType: text("ownership_type"),
  parentCompany: text("parent_company"),
  advisoryArms: text("advisory_arms"),
  officeLocations: text("office_locations"),
  employeeCountBand: text("employee_count_band"),
  investmentProfessionalsCount: integer("investment_professionals_count"),
  seniorInvestmentProfessionalsCount: integer("senior_investment_professionals_count"),
  topQuartileFlag: text("top_quartile_flag"),
  trackRecordYears: integer("track_record_years"),
  performanceDataAvailable: boolean("performance_data_available"),
  esgPolicyAvailable: boolean("esg_policy_available"),
  priSignatory: boolean("pri_signatory"),
  deiPolicyAvailable: boolean("dei_policy_available"),
  sustainabilityReportUrl: text("sustainability_report_url"),
  ...
  linkedFundsCount: integer("linked_funds_count"),
  linkedLpsCount: integer("linked_lps_count"),
  linkedPortfolioCompaniesCount: integer("linked_portfolio_companies_count"),
  linkedServiceProvidersCount: integer("linked_service_providers_count"),
  email: text("email"),
  phone: text("phone"),
...
export const entitiesLp = pgTable("entities_lp", {
  ...
  lpShortName: text("lp_short_name"),
  lpType: text("lp_type"),
  ...
  totalAum: numeric("total_aum"),
  aumCurrency: text("aum_currency"),
  privateMarketsAllocationPercent: numeric("private_markets_allocation_percent"),
  targetAllocationPercent: numeric("target_allocation_percent"),
  assetClassPreferences: text("asset_class_preferences"),
  geographicPreferences: text("geographic_preferences"),
  industryPreferences: text("industry_preferences"),
  activeFundCommitmentsCount: integer("active_fund_commitments_count"),
  totalFundCommitmentsLifetime: integer("total_fund_commitments_lifetime"),
  directInvestmentFlag: boolean("direct_investment_flag"),
  coInvestmentFlag: boolean("co_investment_flag"),
  averageCommitmentSize: numeric("average_commitment_size"),
  commitmentSizeCurrency: text("commitment_size_currency"),
  ownershipType: text("ownership_type"),
  employeeCountBand: text("employee_count_band"),
  investmentTeamSize: integer("investment_team_size"),
  internalManagementFlag: boolean("internal_management_flag"),
  outsourcingFlag: boolean("outsourcing_flag"),
  fundStagePreference: text("fund_stage_preference"),
  fundSizePreference: text("fund_size_preference"),
  ticketSizeBand: text("ticket_size_band"),
  esgPolicyAvailable: boolean("esg_policy_available"),
  priSignatory: boolean("pri_signatory"),
  impactInvestingFlag: boolean("impact_investing_flag"),
  exclusionsPolicy: text("exclusions_policy"),
  sustainabilityReportUrl: text("sustainability_report_url"),
  dataConfidenceScore: numeric("data_confidence_score"),
  verificationMethod: text("verification_method"),
  lastVerifiedDate: text("last_verified_date"),
  sourceCoverage: text("source_coverage"),
  linkedGpsCount: integer("linked_gps_count"),
  linkedFundsCount: integer("linked_funds_count"),
  linkedServiceProvidersCount: integer("linked_service_providers_count"),
  email: text("email"),
  phone: text("phone"),
...
export const entitiesPortfolioCompany = pgTable("entities_portfolio_company", {
  ...
  latestRevenue: numeric("latest_revenue"),
  ...
  controllingGpId: varchar("controlling_gp_id"),
  controllingFundId: varchar("controlling_fund_id"),
  firstInvestmentYear: integer("first_investment_year"),
  totalFundingRaised: numeric("total_funding_raised"),
  fundingCurrency: text("funding_currency"),
  primaryMarkets: text("primary_markets"),
  manufacturingPresenceFlag: boolean("manufacturing_presence_flag"),
  rAndDPresenceFlag: boolean("r_and_d_presence_flag"),
  esgPolicyAvailable: boolean("esg_policy_available"),
  environmentalFocus: text("environmental_focus"),
  socialFocus: text("social_focus"),
  governanceFocus: text("governance_focus"),
  complianceCertifications: text("compliance_certifications"),
  sustainabilityReportUrl: text("sustainability_report_url"),
  ...
  linkedGpsCount: integer("linked_gps_count"),
  linkedFundsCount: integer("linked_funds_count"),
  linkedDealsCount: integer("linked_deals_count"),
  linkedServiceProvidersCount: integer("linked_service_providers_count"),
...
export const entitiesServiceProvider = pgTable("entities_service_provider", {
  ...
  serviceProviderLegalName: text("service_provider_legal_name"),
  serviceProviderShortName: text("service_provider_short_name"),
  serviceProviderType: text("service_provider_type"),
  ...
  secondaryServices: text("secondary_services"),
  assetClassCoverage: text("asset_class_coverage"),
  fundStageCoverage: text("fund_stage_coverage"),
  typicalClientType: text("typical_client_type"),
  clientSizeFocus: text("client_size_focus"),
  clientCountBand: text("client_count_band"),
  notableClients: text("notable_clients"),
  ownershipType: text("ownership_type"),
  employeeCountBand: text("employee_count_band"),
  globalReach: text("global_reach"),
  regionalStrength: text("regional_strength"),
  industryCertifications: text("industry_certifications"),
  dataSecurityCertifications: text("data_security_certifications"),
...
export const entitiesContact = pgTable("entities_contact", {
  ...
  functionalExpertise: text("functional_expertise"),
  primaryEntityType: text("primary_entity_type"),
  primaryEntityId: varchar("primary_entity_id"),
  primaryEntityNameSnapshot: text("primary_entity_name_snapshot"),
  assetCategorySnapshot: text("asset_category_snapshot"),
  assetSourceEntityType: text("asset_source_entity_type"),
  assetSourceEntityId: varchar("asset_source_entity_id"),
  ...
  roleStartYear: integer("role_start_year"),
  roleEndYear: integer("role_end_year"),
  previousEmployers: text("previous_employers"),
  boardMembershipFlag: boolean("board_membership_flag"),
  decisionMakerFlag: boolean("decision_maker_flag"),
  investmentCommitteeMemberFlag: boolean("investment_committee_member_flag"),
  dealInvolvementFlag: boolean("deal_involvement_flag"),
  verificationStatus: text("verification_status"),
  verificationMethod: text("verification_method"),
  lastVerifiedDate: text("last_verified_date"),
  emailValidatedFlag: boolean("email_validated_flag"),
  phoneValidatedFlag: boolean("phone_validated_flag"),
  contactConfidenceScore: numeric("contact_confidence_score"),
...
export const entitiesDeal = pgTable("entities_deal", {
  ...
  portfolioCompanyId: varchar("portfolio_company_id"),
  gpNameSnapshot: text("gp_name_snapshot"),
  fundNameSnapshot: text("fund_name_snapshot"),
  portfolioCompanyNameSnapshot: text("portfolio_company_name_snapshot"),
  dealSize: numeric("deal_size"),
  dealCurrency: text("deal_currency"),
  equityInvested: numeric("equity_invested"),
  debtInvested: numeric("debt_invested"),
  ownershipPercentage: numeric("ownership_percentage"),
  valuationPre: numeric("valuation_pre"),
  valuationPost: numeric("valuation_post"),
  investmentRound: text("investment_round"),
  securityType: text("security_type"),
  syndicationFlag: boolean("syndication_flag"),
  leadInvestorFlag: boolean("lead_investor_flag"),
  dealCountry: text("deal_country"),
  ...
  grossMultiple: numeric("gross_multiple"),
  netMultiple: numeric("net_multiple"),
  realizedFlag: boolean("realized_flag"),
  esgConsiderationFlag: boolean("esg_consideration_flag"),
  impactDealFlag: boolean("impact_deal_flag"),
  sustainabilityTheme: text("sustainability_theme"),
  dataConfidenceScore: numeric("data_confidence_score"),
  verificationMethod: text("verification_method"),
  lastVerifiedDate: text("last_verified_date"),
  sourceCoverage: text("source_coverage"),
  ...
  acquirerCompanyId: text("acquirer_company_id"),
